...
//	    List<WebElement> navElements = driver.findElements(By.xpath("//mat-toolbar //span[@class='mat-button-wrapper']"));
//	    return navElements.stream().map(WebElement::getText).collect(Collectors.toList());
//	}
	...
	public int getNavItemPosition(String itemName)
	{
	    ...
	    for (int i = 0; i < navItems.size(); i++) {
	        ...
	        if (WebDriverWaitUtility.waitForElementToBeVisible(item).getText().equalsIgnoreCase(itemName)) {
